 ...
 * @author soft
 */
public class InsertPuzzle extends javax.swing.JFrame {

    /**
     * Creates new form InsertPuzzle
     */
    ...
    private void initComponents() {
        ...
        verifyL = new javax.swing.JLabel();
        ...
        verifyL.setBackground(new java.awt.Color(255, 102, 255));
        verifyL.setFont(new java.awt.Font("Comic Sans MS", 1, 24)); // NOI18N
        verifyL.setForeground(new java.awt.Color(255, 255, 255));
        verifyL.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        verifyL.setText("Verify");
        verifyL.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        verifyL.setOpaque(true);
        verifyL.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                verifyLMouseClicked(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(clearAllL, javax.swing.GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE)
                    .addComponent(verifyL, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(143, 143, 143)
                .addComponent(verifyL, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(88, 88, 88)
    ...
    if(submitL.isEnabled())
    {
        if(verify())
        {
            ...
            try
            {
                ...
                fw.write('U');
                fw.close();
                BasicSudoku.setMessage(2, messageL, "Submitted");
                submitL.setEnabled(false);
                
            }
            catch(IOException ioe)
            {
                System.out.println("Exception in InsertPuzzle.submitLMouseClicked: "+ioe.getMessage());
            }
        }
        else
        {
            BasicSudoku.setMessage(1, messageL,"Can not be submitted, check and TRY AGAIN !!!");
        }
    }
    ...
    private void verifyLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_verifyLMouseClicked
     verify();      
    }//GEN-LAST:event_verifyLMouseClicked
    ...
    if(BasicSudoku.Verify(sud,l,messageL))
    {
        ...
        {
            BasicSudoku.setMessage(2,messageL,"verified !!!");
           /* for(int i=0;i<9;i++)
                for(int j=0;j<9;j++)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertPuzzle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertPuzzle().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel verifyL;
